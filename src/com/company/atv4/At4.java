...
public class At4 {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        URL urlBebida = At4.class.getResource("bebidas-tabuladas.txt");
        listCompleta.add(MenuFileProcessor.processar(urlBebida, "\t"));

        URL urlVinho = At4.class.getResource("vinhos-tabulados.txt");
        listCompleta.add(MenuFileProcessor.processar(urlVinho, "\t"));

        URL urlPrato = At4.class.getResource("pratos.csv");
